 ...
 */
registerBlockType( 'dz/contact', {
	// Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
	title: __( 'contact' ), // Block title.
	...
	edit: ( {attributes, setAttributes} ) => {
		...
		const supportChange = (newText) => {
			setAttributes({ support: newText });			
		};
		const officeChange = (newText) => {
			setAttributes({ office: newText });			
		};	
